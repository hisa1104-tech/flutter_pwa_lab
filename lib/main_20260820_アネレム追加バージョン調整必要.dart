...
class _MainRecordPageState extends State<MainRecordPage> {
  ...
  bool _showDexRow = false;
  bool _showRemimazolamInfRow = false; // 👈 追加
  bool _showRemimazolamIvRow = false;  // 👈 追加
  bool _showFlumazenilRow = false;     // 👈 追加
  bool _showEphedrineRow = false;      // 👈 追加
  bool _showNeosynephrineRow = false;  // 👈 追加
  bool _showAtropineRow = false;       // 👈 追加
  ...
  final TextEditingController _remimazolamInfController = TextEditingController(); // 👈 追加

  String _propofolInfUnit = 'mg/kg/h';
  String _dexUnit = 'μg/kg/h';
  String _remimazolamInfUnit = 'mg/kg/h'; // 👈 追加
  ...
  final TextEditingController _remimazolamBolusController = TextEditingController(); // 👈 追加
  final TextEditingController _flumazenilController = TextEditingController();       // 👈 追加
  final TextEditingController _ephedrineController = TextEditingController();        // 👈 追加
  final TextEditingController _neosynephrineController = TextEditingController();    // 👈 追加
  final TextEditingController _atropineController = TextEditingController();         // 👈 追加
  ...
  String _presetRemimazolamUnit = 'mg/kg/h';
  ...
  Future<void> _loadSettings() async {
    ...
    setState(() {
      ...
      _presetRemimazolamUnit = box.get('remimazolam_unit', defaultValue: 'mg/kg/h');
  ...
  Future<void> _saveSettings() async {
    ...
    await box.put('remimazolam_unit', _presetRemimazolamUnit);
  ...
  void _showSettingsDialog() {
    ...
    String tempRemimazolamUnit = _presetRemimazolamUnit;
        ...
        return StatefulBuilder(
          builder: (context, setDialogState) {
            ...
            final Map<String, String> drugs = {
              ...
              'PropofolCiv': 'Pro civ', 'PropofolIv': 'Pro iv',
              'Midazolam': 'Mida iv',
              'RemimazolamCiv': 'Remi civ', 'RemimazolamIv': 'Remi iv',
              'Flumazenil': 'フルマゼニル', 'Ephedrine': 'エフェドリン',
              'Neosynephrine': 'ネオシネジン', 'Atropine': 'アトロピン',
              'Acerio': 'アセリオ', 'Ropion': 'ロピオン', 'LA': '局所麻酔', 'Fluid': '輸液合計',
            };
                          ...
                          Expanded(
                            child: ListView(
                              ...
                              children: drugs.entries.map((e) {
                                ...
                                } else if (e.key == 'RemimazolamCiv') {
                                  dropdown = buildInlineDropdown(tempRemimazolamUnit, ['mg/kg/h', 'mL/h'], (v) => tempRemimazolamUnit = v);
                                } else if (e.key == 'LA') {
                    ...
                    ElevatedButton(
                      onPressed: () {
                        setState(() {
                          ...
                          _presetRemimazolamUnit = tempRemimazolamUnit;
  ...
  Map<String, dynamic> _createAllDataMap() {
    return {
      ...
      'toggles': {
        ...
        'showDex': _showDexRow,
        'showRemimazolamInf': _showRemimazolamInfRow,
        'showRemimazolamIv': _showRemimazolamIvRow,
        'showFlumazenil': _showFlumazenilRow,
        'showEphedrine': _showEphedrineRow,
        'showNeosynephrine': _showNeosynephrineRow,
        'showAtropine': _showAtropineRow,
      },
      ...
      'settings': {
        ...
        'dexUnit': _dexUnit,
        'remimazolamUnit': _remimazolamInfUnit,
  ...
  void _applyDataMap(Map<String, dynamic> data) {
    setState(() {
      ...
      if (data['infusionMap'] != null) {
        ...
        ['O2', 'N2O', 'PropofolInf', 'Dex', 'RemimazolamInf'].forEach((key) {
      ...
      if (data['toggles'] != null) {
        ...
        _showRemimazolamInfRow = t['showRemimazolamInf'] ?? false;
        _showRemimazolamIvRow = t['showRemimazolamIv'] ?? false;
        _showFlumazenilRow = t['showFlumazenil'] ?? false;
        _showEphedrineRow = t['showEphedrine'] ?? false;
        _showNeosynephrineRow = t['showNeosynephrine'] ?? false;
        _showAtropineRow = t['showAtropine'] ?? false;
      }
      ...
      if (data['settings'] != null) {
        ...
        _remimazolamInfUnit = s['remimazolamUnit'] ?? 'mg/kg/h';
  ...
  Future<void> _clearAllData() async {
    ...
    setState(() {
      ...
      _remimazolamInfUnit = _presetRemimazolamUnit;
      ...
      _showRemimazolamInfRow = _presetVisibleRows.contains('RemimazolamCiv');
      _showRemimazolamIvRow = _presetVisibleRows.contains('RemimazolamIv');
      _showFlumazenilRow = _presetVisibleRows.contains('Flumazenil');
      _showEphedrineRow = _presetVisibleRows.contains('Ephedrine');
      _showNeosynephrineRow = _presetVisibleRows.contains('Neosynephrine');
      _showAtropineRow = _presetVisibleRows.contains('Atropine');
      ...
      body: SafeArea(
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            final fixedDrugs = ['Propofol', 'Midazolam', 'Remimazolam', 'フルマゼニル', 'エフェドリン', 'ネオシネジン', 'アトロピン', 'LA', 'アセリオ', 'ロピオン', _selectedLaDrug];
                                                ...
                                                Expanded(
                                                  ...
                                                  child: ListView(
                                                    ...
                                                    children: [
                                                      ...
                                                      if (_presetVisibleRows.contains('RemimazolamCiv') && !_hiddenRowKeys.contains('RemimazolamCiv'))
                                                        _buildTimelineRow(
                                                          label: 'Remimazolam civ [$_remimazolamInfUnit]',
                                                          rowKey: 'RemimazolamCiv',
                                                          maxMinutes: maxX,
                                                          children: _getInfusionGraphics('RemimazolamInf', maxX, chartW, Colors.blueAccent),
                                                          bgColor: Colors.blueAccent.withOpacity(0.01),
                                                        ),

                                                      if (_presetVisibleRows.contains('RemimazolamIv') && !_hiddenRowKeys.contains('RemimazolamIv'))
                                                        _buildTimelineRow(
                                                          label: 'Remimazolam iv [mg]',
                                                          rowKey: 'RemimazolamIv',
                                                          maxMinutes: maxX,
                                                          children: _getBolusPins('Remimazolam', maxX, chartW, Colors.lightBlueAccent),
                                                          bgColor: Colors.blueAccent.withOpacity(0.01),
                                                        ),

                                                      if (_presetVisibleRows.contains('Flumazenil') && !_hiddenRowKeys.contains('Flumazenil'))
                                                        _buildTimelineRow(
                                                          label: 'フルマゼニル [mg]',
                                                          rowKey: 'Flumazenil',
                                                          maxMinutes: maxX,
                                                          children: _getBolusPins('フルマゼニル', maxX, chartW, Colors.redAccent.shade100),
                                                          bgColor: Colors.redAccent.withOpacity(0.01),
                                                        ),

                                                      if (_presetVisibleRows.contains('Ephedrine') && !_hiddenRowKeys.contains('Ephedrine'))
                                                        _buildTimelineRow(
                                                          label: 'エフェドリン [mg]',
                                                          rowKey: 'Ephedrine',
                                                          maxMinutes: maxX,
                                                          children: _getBolusPins('エフェドリン', maxX, chartW, Colors.greenAccent.shade700),
                                                          bgColor: Colors.greenAccent.withOpacity(0.01),
                                                        ),

                                                      if (_presetVisibleRows.contains('Neosynephrine') && !_hiddenRowKeys.contains('Neosynephrine'))
                                                        _buildTimelineRow(
                                                          label: 'ネオシネジン [mg]',
                                                          rowKey: 'Neosynephrine',
                                                          maxMinutes: maxX,
                                                          children: _getBolusPins('ネオシネジン', maxX, chartW, Colors.orangeAccent.shade700),
                                                          bgColor: Colors.orangeAccent.withOpacity(0.01),
                                                        ),

                                                      if (_presetVisibleRows.contains('Atropine') && !_hiddenRowKeys.contains('Atropine'))
                                                        _buildTimelineRow(
                                                          label: 'アトロピン [mg]',
                                                          rowKey: 'Atropine',
                                                          maxMinutes: maxX,
                                                          children: _getBolusPins('アトロピン', maxX, chartW, Colors.pinkAccent.shade100),
                                                          bgColor: Colors.pinkAccent.withOpacity(0.01),
                                                        ),
                                ...
                                child: Container(
                                  ...
                                  child: ListView(
                                    children: [
                                      ...
                                      if (_presetVisiblePanelRows.contains('RemimazolamCiv'))
                                      _alignedDrugRow(
                                        label: 'Remimazolam civ:',
                                        child: Row(
                                          children: [
                                            Expanded(
                                              flex: 3,
                                              child: TextField(
                                                controller: _remimazolamInfController,
                                                keyboardType: const TextInputType.numberWithOptions(decimal: true),
                                                style: const TextStyle(fontSize: 11),
                                                decoration: const InputDecoration(
                                                  hintText: '速度',
                                            ...
                                            const SizedBox(width: 2),
                                            DropdownButton<String>(
                                              value: _remimazolamInfUnit,
                                              isDense: true,
                                              items: <String>{'mg/kg/h', 'mL/h', _remimazolamInfUnit}
                                                  .map((u) => DropdownMenuItem(value: u, child: Text(u, style: const TextStyle(fontSize: 9))))
                                                  .toList(),
                                              onChanged: (v) {
                                                setState(() => _remimazolamInfUnit = v!);
                                                _saveAllData();
                                              },
                                            ),
                                          ],
                                        ...
                                        suffix: Row(
                                          children: [
                                            Expanded(
                                              child: ElevatedButton(
                                                onPressed: () {
                                                  if (_remimazolamInfController.text.isEmpty) return;
                                                  _addInfusionPoint('RemimazolamInf', _remimazolamInfController.text);
                                                  _remimazolamInfController.clear();
                                                },
                                                style: ElevatedButton.styleFrom(
                                            ...
                                            SizedBox(
                                              width: 32,
                                              child: ElevatedButton(
                                                onPressed: () => _stopInfusionPoint('RemimazolamInf'),
                                                style: ElevatedButton.styleFrom(
                                                  backgroundColor: Colors.grey,
                                                  foregroundColor: Colors.white,
                                                  padding: EdgeInsets.zero,
                                      ...
                                      if (_presetVisiblePanelRows.contains('RemimazolamIv'))
                                      _alignedDrugRow(
                                        label: 'Remimazolam iv:',
                                        child: TextField(
                                          controller: _remimazolamBolusController,
                                          keyboardType: const TextInputType.numberWithOptions(decimal: true),
                                          style: const TextStyle(fontSize: 11),
                                          decoration: const InputDecoration(
                                            hintText: 'mg',
                                        ...
                                        suffix: ElevatedButton(
                                          onPressed: () {
                                            if (_remimazolamBolusController.text.isEmpty) return;
                                            _addBolus('Remimazolam', _remimazolamBolusController.text, 'mg');
                                            _remimazolamBolusController.clear();
                                          },
                                          style: ElevatedButton.styleFrom(
                                      ...
                                      if (_presetVisiblePanelRows.contains('Flumazenil'))
                                      _alignedDrugRow(
                                        label: 'フルマゼニル :',
                                        child: TextField(
                                          controller: _flumazenilController,
                                          keyboardType: const TextInputType.numberWithOptions(decimal: true),
                                          style: const TextStyle(fontSize: 11),
                                          decoration: const InputDecoration(
                                            hintText: 'mg',
                                        ...
                                        suffix: ElevatedButton(
                                          onPressed: () {
                                            if (_flumazenilController.text.isEmpty) return;
                                            _addBolus('フルマゼニル', _flumazenilController.text, 'mg');
                                            _flumazenilController.clear();
                                          },
                                          style: ElevatedButton.styleFrom(
                                      ...
                                      if (_presetVisiblePanelRows.contains('Ephedrine'))
                                      _alignedDrugRow(
                                        label: 'エフェドリン :',
                                        child: TextField(
                                          controller: _ephedrineController,
                                          keyboardType: const TextInputType.numberWithOptions(decimal: true),
                                          style: const TextStyle(fontSize: 11),
                                          decoration: const InputDecoration(
                                            hintText: 'mg',
                                        ...
                                        suffix: ElevatedButton(
                                          onPressed: () {
                                            if (_ephedrineController.text.isEmpty) return;
                                            _addBolus('エフェドリン', _ephedrineController.text, 'mg');
                                            _ephedrineController.clear();
                                          },
                                          style: ElevatedButton.styleFrom(
                                      ...
                                      if (_presetVisiblePanelRows.contains('Neosynephrine'))
                                      _alignedDrugRow(
                                        label: 'ネオシネジン :',
                                        child: TextField(
                                          controller: _neosynephrineController,
                                          keyboardType: const TextInputType.numberWithOptions(decimal: true),
                                          style: const TextStyle(fontSize: 11),
                                          decoration: const InputDecoration(
                                            hintText: 'mg',
                                        ...
                                        suffix: ElevatedButton(
                                          onPressed: () {
                                            if (_neosynephrineController.text.isEmpty) return;
                                            _addBolus('ネオシネジン', _neosynephrineController.text, 'mg');
                                            _neosynephrineController.clear();
                                          },
                                          style: ElevatedButton.styleFrom(
                                      ...
                                      if (_presetVisiblePanelRows.contains('Atropine'))
                                      _alignedDrugRow(
                                        label: 'アトロピン :',
                                        child: TextField(
                                          controller: _atropineController,
                                          keyboardType: const TextInputType.numberWithOptions(decimal: true),
                                          style: const TextStyle(fontSize: 11),
                                          decoration: const InputDecoration(
                                            hintText: 'mg',
                                        ...
                                        suffix: ElevatedButton(
                                          onPressed: () {
                                            if (_atropineController.text.isEmpty) return;
                                            _addBolus('アトロピン', _atropineController.text, 'mg');
                                            _atropineController.clear();
                                          },
                                          style: ElevatedButton.styleFrom(
