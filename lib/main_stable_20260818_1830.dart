                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Expanded(flex: 7, child: Text('単位 / 初期薬', textAlign: TextAlign.center, style: TextStyle(fontSize: 9, color: Colors.grey.shade600))),
                            ...
                            child: ListView(
                              ...
                              children: drugs.entries.map((e) {
                                ...
                                return Container(
                                  ...
                                  child: Row(
                                    children: [
                                      Expanded(flex: 6, child: Text(e.value, style: const TextStyle(fontSize: 11))),
                                      Expanded(flex: 7, child: Padding(padding: const EdgeInsets.symmetric(horizontal: 4), child: dropdown ?? const SizedBox.shrink())),
                                      Expanded(
                                        flex: 3,
                                        child: Center(
                                          child: Checkbox(
                        ...
                        child: Column(
                          ...
                          children: [
                            const Padding(
                              ...
                              child: Text('【ルート確保の設定】', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Colors.blueGrey)),
                            ),
                            ...
                            const Text('【麻酔担当医の設定】', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Colors.blueGrey)),
