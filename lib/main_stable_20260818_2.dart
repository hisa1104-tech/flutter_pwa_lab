                        ...
                        child: Column(
                          ...
                          children: [
                            const Padding(
                              ...
                              child: Text('【表示項目】', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Colors.blueGrey)),
                            ),
                            ...{
                              'O2': 'O2',
                              'N2O': 'N2O',
                              'Dex': 'Dex civ',
                              'PropofolCiv': 'Propofol civ',
                              'PropofolIv': 'Propofol iv',
                              'Midazolam': 'Midazolam iv',
                              'Acerio': 'アセリオ',
                              'Ropion': 'ロピオン',
                              'LA': '局所麻酔',
                              'Fluid': '輸液',
                            }.entries.map((e) => CheckboxListTile(
                              title: Text(e.value, style: const TextStyle(fontSize: 12)),
                              value: tempVisible.contains(e.key),
                              dense: true,
                              controlAffinity: ListTileControlAffinity.leading, // チェックボックスを左側へ
                        ...
                        child: Column(
                          ...
                          children: [
                            const Padding(
                              ...
                              child: Text('【初期値の設定】', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Colors.blueGrey)),
                            ),
                            buildDropdownSetting('デフォルトゲージ', tempIvGauge, ['20G', '22G', '24G'], (v) => tempIvGauge = v),
                            buildDropdownSetting('デフォルト穿刺部位', tempIvSite, ['左前腕', '右前腕', '左手背', '右手背', '左肘', '右肘'], (v) => tempIvSite = v, allowFree: true, freeTitle: '新しい穿刺部位', freeHint: '例: 右大腿'),
                            buildDropdownSetting('デフォルト輸液', tempFluid, ['フィジオ140', 'ラクテック注', 'ソルデム3A', '生理食塩水', 'ソリタT1', 'ソリタT3'], (v) => tempFluid = v, allowFree: true, freeTitle: '新しい輸液名', freeHint: '例: ビカネイト'),
                            ...
                            buildDropdownSetting('デフォルト局麻剤', tempLaDrug, ['オーラ注', 'セプトカイン', 'スキャンドネスト', 'シタネスト', 'エピリド', 'キシロカイン',], (v) => tempLaDrug = v, allowFree: true, freeTitle: '新しい局麻剤', freeHint: '例: アナペイン'),
                          ],
                        ),
                      ),
                    ),
