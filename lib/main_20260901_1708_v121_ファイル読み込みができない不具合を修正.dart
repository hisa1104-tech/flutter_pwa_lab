...
class _MainRecordPageState extends State<MainRecordPage> {
  ...
  Future<void> _importFromFile() async {
    try {
      // 💡 最新の FilePicker.platform.pickFiles 形式が定義エラーになるため、
      // 以前動作していた FilePicker.pickFiles に戻し、確実に非同期実行されるように整理します
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                const Text('v1.20', style: TextStyle(color: Colors.white60, fontSize: 8.5)),
                              ],
                            ),
                            const SizedBox(height: 4),
                            Row(
